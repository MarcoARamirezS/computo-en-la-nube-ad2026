# ParkingFlow — Guía docente Full Stack

Proyecto evolutivo con Nuxt 4, Tailwind CSS 4, Pinia, Node.js 24 LTS, Express 5, TypeScript, Firestore, bcryptjs, JWT access/refresh, Cloudinary, PDFKit, Vitest, Supertest y Nuxt Test Utils.
...
5. [Check-in: vehículos y sesiones - Medio Pendiente](./05-checkin-parking-session.md)
